  ...
  useEffect(() => {
    if (id) {
      const fetchInventoryById = async () => {
        ...
        const InventoryJsonResp = await InventoryResponse.json();
        setInventory(InventoryJsonResp);
      };
      fetchInventoryById();
    }
  }, [id]);
          ...
          <Grid>
            <Grid item lg={12} xs={12}>
              <Box display="flex" justifyContent="space-between">
                <Typography className="page-heading" variant="h5">View Inventory</Typography>
                                  ...
                                  <TableCell className={[styles.valueCell, 'row-value'].join(' ')}>
                                    {
                                      ...
                                      <Typography variant="body1">
                                        {inventory[key] !== null &&
                                          moment.utc(inventory[key]).format(
